...
export const TripPlanner = () => {
  ...
  const API_KEY = "AIzaSyCU4Ks3wdEqpHlbBs8y7fifUZz5L6FtY1c"; // ⬅️ Replace with your actual Gemini API key
    ...
    <div className="p-6 space-y-6 bg-gray-900 text-white min-h-screen">
      ...
      {recommendations && (
        <div className="mt-6 p-6 bg-gray-800 rounded-lg shadow-lg max-w-3xl mx-auto">
          ...
          <h3 className="text-lg font-bold mt-6">🍽️ Must-Try Food Spots</h3>
          <ul className="list-disc pl-5 mt-2 space-y-1">
